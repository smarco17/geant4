  ...
  fEnvelopeBox(0)
{
  ...
  */
  ...
  // 粒子を打ち込む方向、引数はG4ThreeVectorクラス
  //
  fParticleGun->SetParticleMomentumDirection(G4ThreeVector(0.,0.,1.));
  // 粒子を打ち込む位置、引数はG4ThereeVectorクラス
  //
...
void B1PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  */
  ...
  // 核分裂後の中性子のエネルギーを2MeVのエネルギーを中心とした正規分布でシミュレーション
  // mean=2.0 sigma=2.0
  // CLHEP::RandGauss::shoot(mean, sigma)
  //
  G4double neutronEnergy = CLHEP::RandGauss::shoot(2.0, 2.0)*MeV;
